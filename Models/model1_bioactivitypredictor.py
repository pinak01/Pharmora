# -*- coding: utf-8 -*-
"""Model1-BioActivityPredictor.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1iZzhECLtL8jPlSknBclzYt7hIV05NlL0
...
df_2class.to_csv('df_2class_NaNDropped.csv')
...
# Pass data as a DataFrame
import pandas as pd
df = pd.DataFrame({'Y_test': Y_test, 'Y_pred': Y_pred})
ax = sns.regplot(data=df, x='Y_test', y='Y_pred', scatter_kws={'alpha':0.4})
